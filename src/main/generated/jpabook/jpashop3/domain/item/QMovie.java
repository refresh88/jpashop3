...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = -1960613667L;
    ...
    //inherited
    public final ListPath<jpabook.jpashop3.domain.Category, jpabook.jpashop3.domain.QCategory> categories = _super.categories;
